  ...
  const sendHandler = async () => {
    ...
    try {
      let res = await USERSAPI.post(
        `/chats/sendchat/${chatId}/${sellerInfo._id}/Seller`,
        { content }
      );
      if (res) {
        setContent("");
          ...
          {chatId ? (
            <div className="h-full">
              ...
              <div
                ...
                className="h-4/6 w-full overflow-y-auto p-5 rounded-3"
              >
                    ...
                    chat.senderType == "Seller" ? (
                      ...
                      <div key={index} className="w-50 my-2">
                        <div
                          ...
                          className="max-w-1/2 w-fit p-3 rounded-tl-lg rounded-tr-lg rounded-br-lg"
                        >
                          {chat.content}
                        </div>
                      </div>
