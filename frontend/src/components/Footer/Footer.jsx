...
function Footer() {
            ...
            <div className="w-full ">
              <div className="single-footer-widget">
                ...
                <p className="text-white   pb-7 text-center">
                  Istay is your ultimate destination for accessing a wide
  ...
  <div className="single-footer-widget">
    ...
    <div className="footer-social flex items-center pb-12 justify-center">
      <a href="https://www.instagram.com/athul_rajk_/" target="_blank" rel="noopener noreferrer">
        <FaInstagram className="text-white m-2" size={24} />
      </a>
      <a href="https://wa.me/9544642360" target="_blank" rel="noopener noreferrer">
        <FaWhatsapp className="text-white m-2" size={24} />
      </a>
      <a href="https://www.linkedin.com/in/athul-rajk/" target="_blank" rel="noopener noreferrer">
